...
def get_strikes_or_ball(user_input_number, random_number):
    ...
    #   - random_number : 9-문자열값으로 컴퓨터가 자동으로 생성된 숫자
    # Output:
...
def main():
    ...
    while user_input <= 1000:
        ...
        if is_validated_number(user_input_number) == True:
            st_ball = get_strikes_or_ball(user_input_number, random_number)
            print("Strikes : {} , Balls : {}".format(st_ball[0], st_ball[1]))
            if st_ball[0] == 3:
                ...
                while True:
                    if is_yes(one_more_input) == True:
                        ...
                        print("Random Number is :", random_number)
                        break
                    elif is_no(one_more_input) == False:
                        if one_more_input == "0":
                            user_input = 1000000
                            break
